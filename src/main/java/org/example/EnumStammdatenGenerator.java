...
public class EnumStammdatenGenerator extends JavaGenerator {
    ...
    protected void generateSchema(SchemaDefinition schema) {
        log.info(schema.getDatabase().getTables().toString());
        ...
        db.getTables(schema).stream()
                ...
                .forEach(tableDefinition -> {
                    ...
                    generateEnum(schema, tableDefinition, db);
    ...
    private void generateEnum(SchemaDefinition schema, TableDefinition tableDefinition, Database db) {
